...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (DB::getDriverName() === 'pgsql') {
            ...
            DB::statement('CREATE FUNCTION prevent_referral_reward_ledger_mutation() RETURNS trigger AS $$ BEGIN RAISE EXCEPTION \'referral reward ledger entries are append-only\'; END; $$ LANGUAGE plpgsql');
            ...
            DB::statement('CREATE FUNCTION prevent_referral_reward_version_mutation() RETURNS trigger AS $$ BEGIN RAISE EXCEPTION \'referral reward program versions are immutable\'; END; $$ LANGUAGE plpgsql');
            ...
            DB::statement('CREATE FUNCTION prevent_referral_payout_event_mutation() RETURNS trigger AS $$ BEGIN RAISE EXCEPTION \'referral payout request events are append-only\'; END; $$ LANGUAGE plpgsql');
