...
- Focused local evidence: `PhaseOneBookingLocationsTest` 8 / 59 and `MilestoneFiveScenarioTest` 26 / 157 pass; PHPStan, Pint, frontend lint/typecheck/build, PHP syntax, and `git diff --check` are passing. Hosted CI, PostgreSQL execution, staging, and owner acceptance remain closeout gates for this draft candidate; production is untouched.
