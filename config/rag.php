...
return [
    ...
    'uploads' => [
        ...
        'allowed_extensions' => ['txt', 'md', 'markdown', 'pdf', 'csv', 'xlsx', 'xls', 'ods'],
        'parsing' => [
            'maximum_processing_seconds' => 15,
            'maximum_pdf_pages' => 100,
            'maximum_archive_entries' => 2000,
            'maximum_archive_uncompressed_bytes' => 50000000,
            'maximum_archive_entry_bytes' => 20000000,
            'maximum_compression_ratio' => 100,
            'maximum_spreadsheet_sheets' => 20,
            'maximum_spreadsheet_rows' => 10000,
            'maximum_spreadsheet_columns' => 100,
            'maximum_spreadsheet_cells' => 100000,
            'maximum_cell_characters' => 10000,
            'pdf_parser_version' => 'prinsfrank/pdfparser-3.3.0',
            'spreadsheet_parser_version' => 'openspout-4.32.0',
            'legacy_xls_parser_version' => 'phpoffice/phpspreadsheet-5.9.0',
        ],
    ],
];
