...
| ASM-008 | Attachment file size limit defaults to 20 MB (20,971,520 bytes) via repository configuration (`MEDICAL_ATTACHMENT_MAX_BYTES`) as a technical default until explicit business-tier quotas are confirmed. | M7A attachment security | Quota/business requirement |
