...
- Referrals: stable opaque organization-scoped referral identities, product-neutral first-touch relationships with automatic/manual provenance, neutral commercial evidence consumption, versioned reward programs, append-only reward accounting, manual payout reservations, and Portal/CRM projections. Relationship establishment, Finance evidence, reward qualification, and payout execution remain separate; the Referrals reward ledger is subordinate to Finance settlement authority and does not provide provider payouts.
