...
final class ScenarioTemplateVariableCatalog
{
    ...
    private const ALLOWED = [
        ...
        'feedback.url',
        'feedback.score',
        'feedback.has_internal_feedback',
        'feedback.crm_url',
        'onboarding.stage',
    ...
    public static function labels(): array
    {
        return [
            ...
            'feedback.score' => 'Оценка визита',
            'feedback.has_internal_feedback' => 'Есть внутренний комментарий',
            'feedback.crm_url' => 'Ссылка на обратную связь в CRM',
            ...
            'survey.portal_url' => 'Ссылка на тесты',
            'survey.has_progress' => 'Наличие сравнимой динамики теста',
            'survey.progress_summary' => 'Краткая динамика теста',
            ...
            'payment.product_name' => 'Название товара или услуги',
            'payment.status_label' => 'Статус платежа',
            'payment.reason' => 'Причина сверки платежа',
            'payment.client_label' => 'Клиент платежа',
            'payment.message' => 'Сообщение о платеже',
            'payment.survey_url' => 'Ссылка на диагностический тест',
            'payment.crm_url' => 'Ссылка на сверку платежа',
            'fulfillment.product_name' => 'Название продукта',
            'fulfillment.status_label' => 'Статус выдачи доступа',
            'fulfillment.reason' => 'Причина ошибки выдачи',
            'fulfillment.message' => 'Сообщение о выдаче доступа',
            'fulfillment.crm_url' => 'Ссылка на оплату и выдачу',
            'reward.amount' => 'Сумма начисления',
