...
class RecordAuditEvent
{
    ...
    private const ALLOWED_METADATA_KEYS = [
        ...
        'referral.reward.redeemed' => ['client_id', 'obligation_id', 'financial_ledger_entry_id', 'amount_minor', 'currency'],
        ...
        'finance.referral_credit.applied' => ['client_id', 'obligation_id', 'amount_minor', 'currency'],
