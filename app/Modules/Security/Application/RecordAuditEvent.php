...
class RecordAuditEvent
{
    ...
    private const ALLOWED_METADATA_KEYS = [
        ...
        'referral.relationship.created' => ['referrer_client_id', 'referred_client_id', 'source_type'],
        'referral.conversion.observed' => ['relationship_id', 'obligation_id', 'ledger_entry_id', 'source'],
        ...
        'feedback.configuration.updated' => ['enabled', 'positive_threshold', 'low_score_feedback_required', 'review_url_ru_set', 'review_url_en_set'],
