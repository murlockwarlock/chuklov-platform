...
class RecordAuditEvent
{
    ...
    private const ALLOWED_METADATA_KEYS = [
        ...
        'referral.partner.activated' => ['client_id', 'source', 'reactivated'],
        ...
        'referral.reward.reversed' => ['beneficiary_client_id', 'referred_client_id', 'relationship_id', 'evidence_id', 'amount_minor', 'currency', 'original_entry_id', 'reason_present'],
        'referral.reward.manual_credit' => ['beneficiary_client_id', 'partner_profile_id', 'amount_minor', 'currency', 'reason_present', 'comment_present'],
        'referral.reward.redeemed' => ['client_id', 'obligation_id', 'financial_ledger_entry_id', 'amount_minor', 'currency', 'source'],
        'referral.reward.restored' => ['client_id', 'obligation_id', 'financial_ledger_entry_id', 'amount_minor', 'currency', 'correction_of', 'reason_present'],
        'referral.payout.requested' => ['beneficiary_client_id', 'amount_minor', 'currency', 'actor_type', 'actor_client_id'],
        'referral.payout.approved' => ['beneficiary_client_id', 'amount_minor', 'currency', 'from_status', 'to_status', 'reason_present', 'payment_reference_present', 'actor_type', 'actor_client_id'],
        'referral.payout.rejected' => ['beneficiary_client_id', 'amount_minor', 'currency', 'from_status', 'to_status', 'reason_present', 'payment_reference_present', 'actor_type', 'actor_client_id'],
        'referral.payout.cancelled' => ['beneficiary_client_id', 'amount_minor', 'currency', 'from_status', 'to_status', 'reason_present', 'payment_reference_present', 'actor_type', 'actor_client_id'],
        'referral.payout.paid' => ['beneficiary_client_id', 'amount_minor', 'currency', 'from_status', 'to_status', 'reason_present', 'payment_reference_present', 'actor_type', 'actor_client_id'],
        ...
        'finance.referral_credit.applied' => ['client_id', 'obligation_id', 'amount_minor', 'currency', 'source'],
        'finance.referral_credit.restored' => ['client_id', 'obligation_id', 'amount_minor', 'currency', 'correction_of', 'reason_present'],
        ...
        'commerce.purchase.paid' => ['gateway', 'source'],
        'commerce.fulfillment.completed' => ['provider_type', 'source'],
        'commerce.fulfillment.failed' => ['provider_type', 'source'],
        ...
        'knowledge.revision.extracted' => ['source_id', 'revision_id', 'parser_type', 'parser_version', 'extraction_status'],
        'knowledge.revision.ai_parse_requested' => ['source_id', 'revision_id', 'capability', 'prompt_version'],
