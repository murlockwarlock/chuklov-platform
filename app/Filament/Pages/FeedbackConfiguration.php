        ...
        return $schema
            ->components([
                ...
                Section::make('Внешние площадки')
                    ->description('Ссылки только показываются клиенту после положительной оценки. Сервер их не запрашивает. Текст сообщения и правило отправки после завершения визита: Коммуникации → Шаблоны сообщений и Коммуникации → Правила сообщений.')
                    ->schema([
                        Placeholder::make('feedback_template_path')
                            ->label('Где изменить сообщение после визита')
                            ->content('Откройте «Шаблоны сообщений» и найдите сценарий оценки визита. Затем проверьте «Правила сообщений» для события «Бронирование завершено».')
                            ->columnSpanFull(),
