...
final class MilestoneFiveBScenarioFamiliesTest extends TestCase
{
    ...
    public function test_repeated_seed_is_organization_scoped_and_never_overwrites_rules(): void
    {
        ...
        $expectedRuleKeys = [
            ...
            'commerce-fulfillment-completed-client-telegram',
            'commerce-fulfillment-failed-client-telegram',
            'commerce-fulfillment-failed-database',
            'commerce-fulfillment-failed-telegram',
        ...
        self::assertSame([
            ...
            'commerce-fulfillment-completed-client:en',
            'commerce-fulfillment-completed-client:ru',
            'commerce-fulfillment-failed-client:en',
            'commerce-fulfillment-failed-client:ru',
